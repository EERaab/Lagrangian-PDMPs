function transition!(pdmp::PDMP{T}, state::BinaryState, evo_data::EvolutionData, numerics::NumericalParameters, dyn_type::GradientReflection{T}; max_duration::Float64 = 0.0) where T<:PDMP_Method
